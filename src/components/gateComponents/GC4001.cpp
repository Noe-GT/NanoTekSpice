...
#include "../../../include/components/gateComponents/GC4001.hpp"

nts::component::GC4001::GC4001(const std::string &name):
    nts::AComponent(name),
    _ng1(),
    _ng2(),
    _ng3(),
...
nts::component::GC4001::~GC4001()
{
}

nts::Tristate nts::component::GC4001::run(size_t pin)
{
    switch (pin) {
        case 3:
